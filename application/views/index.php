	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" method="<?= site_url('Login/index') ?>">
					...
					<span style="background:red;padding: 6px;color:#fff;width:297px;border-radius: 5px;"><?php echo $this->session->flashdata('message'); ?></span>
					</div>
					<?php } ?>
					...
					<div class="login100-form-social flex-c-m">
						<a href="https://www.facebook.com/vinil.lakkavatri" class="login100-form-social-item flex-c-m bg1 m-r-5" target="_blank">
							<i class="fa fa-facebook-f" aria-hidden="true"></i>
						</a>

						<a href="https://in.linkedin.com/in/vinil-lakkavatri-533309108" class="login100-form-social-item flex-c-m bg2 m-r-5" target="_blank">
